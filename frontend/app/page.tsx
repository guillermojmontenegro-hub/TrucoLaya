...
export default function Home() {
  ...
  function retry() {
    ...
    void run(async () => setState(await request<GameState>(`/games/${gameId}`)));
  }
  ...
  return <main className="shell">
    ...
    {!state ? <section className="welcome">
      ...
      <div className="game-heading"><div><p className="eyebrow">PARTIDA EN CURSO</p><h1>Tu mesa de truco</h1></div><span className="game-format">{state.players.length === 2 ? "MANO A MANO" : state.players.length === 4 ? "POR PAREJAS" : "POR TRÍOS"}</span></div>
